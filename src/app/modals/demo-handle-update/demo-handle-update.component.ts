...
@Component({
  selector: 'app-demo-handle-update',
  templateUrl: './demo-handle-update.component.html',
  styleUrls: ['./demo-handle-update.component.scss']
})
export class DemoHandleUpdateComponent {
  ...
  toggleContent() {
    ...
    setTimeout(() => this.modal.handleUpdate());
  }
